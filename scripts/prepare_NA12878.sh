...
# Download the CRAM
wget ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/data_collections/illumina_platinum_pedigree/data/CEU/NA12878/alignment/NA12878.alt_bwamem_GRCh38DH.20150706.CEU.illumina_platinum_ped.cram
...
samtools view NA12878.byname.bam | awk '{if ($3 ~ /chr22(_.*)?$/ || $7 == /chr22(_.*)?$/) print}' | ./scripts/smartSam2Fastq.py --fq1 NA12878.R1.fastq --fq2 NA12878.R2.fastq --drop_secondary --expect_paired
